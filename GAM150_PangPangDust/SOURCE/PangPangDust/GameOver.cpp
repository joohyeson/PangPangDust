...
class Object& GameOver::CreateHudText(class Object& textObject, const char* name, float positionX, float positionY, float scaleX, float scaleY, _TTF_Font* font, const char* textContents, struct SDL_Color color)
{
...
void GameOver::TransformObjects(float dt)
{
